...
![Schichtaufbau eines Wärmedämmverbundsystems](../assets/images/wdvs-schichtaufbau.svg){ width="900" }
...
<div class="quiz" data-title="Verständnis-Check WDVS-System">

<div class="quiz__q" data-correct="3">
<p class="quiz__qtext">Welche Schicht eines WDVS leistet den Hauptbeitrag zur Wärmedämmung?</p>
<ul class="quiz__opts">
...
<div class="quiz__explain">Der <strong>Dämmstoff</strong> trägt mit seinem niedrigen λ-Wert (typisch 0,032–0,040) und einer Dicke von 12–24 cm den allergrößten Teil zum Gesamtwiderstand bei. Bei den Schmitts haben wir gesehen: Die 16-cm-EPS-Schicht stellt allein etwa 4,57 m²·K/W bereit – über 80 % des Gesamtwiderstandes der sanierten Wand.</div>
</div>

<div class="quiz__q" data-correct="2">
<p class="quiz__qtext">Warum dürfen Komponenten verschiedener WDVS-Hersteller nicht miteinander kombiniert werden?</p>
<ul class="quiz__opts">
...
<div class="quiz__explain">Die <strong>allgemeine bauaufsichtliche Zulassung</strong> wird für das Gesamtsystem aus aufeinander abgestimmten Komponenten erteilt. Eine Mischung mit Komponenten anderer Hersteller verlässt diese Zulassung – das Bauteil ist dann formal nicht mehr regelkonform und Schäden sind nicht mehr abgesichert.</div>
</div>

<div class="quiz__q" data-correct="1">
<p class="quiz__qtext">Welcher entscheidende Vorteil spricht für ein WDVS gegenüber einer Innendämmung?</p>
<ul class="quiz__opts">
...
<div class="quiz__explain">Die <strong>außenliegende Dämmung umschließt das gesamte Mauerwerk</strong>, sodass typische Wärmebrücken (z. B. Heizkörpernischen, Rollladenkästen) automatisch mit überdämmt werden. Außerdem geht keine Wohnfläche verloren. Innendämmung ist bauphysikalisch deutlich anspruchsvoller und meist die Notlösung – z. B. bei denkmalgeschützten Fassaden.</div>
</div>

<div class="quiz__q" data-correct="2">
<p class="quiz__qtext">Welche Funktion hat das Glasfasergewebe in der Armierungsschicht?</p>
<ul class="quiz__opts">
...
<div class="quiz__explain">Sonneneinstrahlung und Frost führen zu Längenänderungen des Putzes. Das <strong>Glasfasergewebe</strong> nimmt diese Spannungen auf und verteilt sie gleichmäßig – ohne das Gewebe würde der Putz reißen. Verdübelung übernehmen die Tellerdübel, Befestigung am Mauerwerk macht der Klebemörtel.</div>
</div>

<div class="quiz__q" data-correct="3">
<p class="quiz__qtext">In welcher Situation wäre eine Innendämmung tatsächlich die richtige Wahl?</p>
<ul class="quiz__opts">
...
<div class="quiz__explain">Bei <strong>Denkmalschutz oder gestalterisch wichtigen Sichtfassaden</strong> bleibt nur die Innendämmung. Sie ist anspruchsvoller in der Ausführung (Tauwasserrisiko, Wärmebrücken, Verlust an Wohnfläche), aber sie ändert die äußere Erscheinung des Gebäudes nicht.</div>
</div>

<div class="quiz__q" data-correct="2">
<p class="quiz__qtext">Welche Aussage zu Tellerdübeln im WDVS ist richtig?</p>
<ul class="quiz__opts">
...
<div class="quiz__explain">Die <strong>Hauptbefestigung übernimmt der Klebemörtel</strong>, die Tellerdübel sind die <strong>mechanische Sicherung</strong>. Typisch sind 6–8 Dübel pro m². Mehr werden bei höheren Gebäuden oder windexponierten Lagen gesetzt. Moderne Tellerdübel mit Dämmstoff-Rondelle reduzieren die Wärmebrückenwirkung auf ein vernachlässigbares Maß.</div>
</div>
...
<p>Stell dir vor, ihr lasst selbst ein WDVS am eigenen Haus anbringen. Worauf würdet ihr beim Auftragnehmer und bei der Ausführung besonders achten – auch wenn ihr selbst nicht jeden Tag auf der Baustelle stehen könnt?</p>
</div>

<div class="discuss__item discuss__item--debate">
<span class="discuss__tag">Diskussion</span>
<p>Es gibt eine kontroverse öffentliche Debatte zum Brandschutz von EPS-WDVS. Auslöser waren u.&nbsp;a. der Hochhausbrand in London (Grenfell Tower 2017) und einzelne Fassadenbrände in Deutschland. Welche Argumente hört ihr in der Praxis pro Mineralwolle (A-Klasse, nichtbrennbar) gegenüber EPS (E/B1, schwer entflammbar)? Wo hört die berechtigte Sorge auf, wo beginnt die nicht ausreichend differenzierte Risikoeinschätzung?</p>
<p class="discuss__hint">Recherche-Anregung: Was sind die Anforderungen an Brandriegel im EPS-WDVS bei Wohngebäuden vs. Hochhäusern? Wie häufig sind Fassadenbrände bei EFH-WDVS in der Statistik?</p>
</div>

<div class="discuss__item discuss__item--debate">
<span class="discuss__tag">Diskussion</span>
<p>Ein häufig gehörter Kritikpunkt am WDVS: „<em>Die Häuser werden alle gleich verspargelt – mit dicken Styropor-Paketen verlieren sie ihren Charakter.</em>" Wo liegen die ästhetischen und stadtbildlichen Grenzen einer flächendeckenden WDVS-Sanierung? Welche Gestaltungsoptionen haben Bauherrinnen und Bauherren trotzdem (Putzstrukturen, Farben, Klinker-Anmutung, Holzverkleidungen, vorgehängte Fassaden)?</p>
</div>
